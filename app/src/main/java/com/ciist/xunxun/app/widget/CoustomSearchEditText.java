 ...
 */
public class CoustomSearchEditText extends EditText implements
    ...
    public CoustomSearchEditText(Context context) {
        this(context, null);
    }

    public CoustomSearchEditText(Context context, AttributeSet attrs) {
        //这里构造方法也很重要，不加这个很多属性不能再XML里面定义
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public CoustomSearchEditText(Context context, AttributeSet attrs, int defStyle) {
