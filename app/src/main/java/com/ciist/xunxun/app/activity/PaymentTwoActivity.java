 ...
 */
public class PaymentTwoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String shwoText = getIntent().getStringExtra("SHOWTEXT");
        String showPrice = getIntent().getStringExtra("SHOWPRICE");



        findViewById(R.id.payment_pay_wx).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //点击微信支付功能执行的操作
        //        Toast.makeText(PaymentTwoActivity.this,"支付开始",Toast.LENGTH_SHORT).show();
                gotoWechat();
   ...
   //获取产品订单信息
    private String genProductArgs() {
        ...
        try {
            ...
            packageParams.add(new BasicNameValuePair("body", "支付测试"));  //简单描述
            ...
            double price = Double.parseDouble("1.00")*100;
            ...
            String xmlstring = parseNodeToXML(packageParams);

            Log.e("test","xml---------"+xmlstring);
            return xmlstring;
